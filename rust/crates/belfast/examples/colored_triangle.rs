...
impl Example for ColoredTriangle {
    fn new(context: &ExampleContext) -> Self {
        ...
        let colors = [1.0_f32, 0.2, 0.15, 0.15, 0.95, 0.35, 0.2, 0.4, 1.0];
        ...
        let color_buffer = Buffer::from_data(
            ...
            &colors,
            BufferUsage::vertex(),
            "ColoredTriangleColors",
        );
        let mesh = Mesh::new(3)
            .expect("colored triangle mesh")
        ...
        let draw = Draw::new(
            ...
            &mesh,
            DrawOptions::new("ColoredTriangle", context.format),
        );
        Self { mesh, draw }
    }
        ...
        let mut encoder =
            context
                ...
                .create_command_encoder(&wgpu::CommandEncoderDescriptor {
                    label: Some("ColoredTriangleEncoder"),
                });
        {
...
fn main() {
    common::run::<ColoredTriangle>("Belfast Rust - Colored Triangle");
}
