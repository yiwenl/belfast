...
#[cfg(target_arch = "wasm32")]
use crate::{
    draw::DrawState, texture::TextureState, to_js_error, WasmDevice, WasmDraw, WasmTexture,
};
...
impl BindGroupOptionsInput {
    fn resolve(self) -> BindGroupOptions {
        BindGroupOptions {
            ...
            label: self.label.unwrap_or_else(|| "TextureBindGroup".into()),
        }
    }
}
